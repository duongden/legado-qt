...
class DictRuleViewModel(application: Application) : BaseViewModel(application) {
    ...
    fun update(vararg dictRule: DictRule) {
        execute {
            ...
            val msg = context.getString(io.legado.app.R.string.error_update_dict_rule, it.localizedMessage)
            AppLog.put(msg, it)
    ...
    fun delete(vararg dictRule: DictRule) {
        execute {
            ...
            val msg = context.getString(io.legado.app.R.string.error_delete_dict_rule, it.localizedMessage)
            AppLog.put(msg, it)
            context.toastOnUi(msg)
        }
    }
