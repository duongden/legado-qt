...
object BookList {
    ...
    suspend fun analyzeBookList(
        ...
        Debug.log(bookSource.bookSourceUrl, "${appCtx.getString(R.string.log_get_success)}${analyzeUrl.ruleUrl}")
        ...
        if (isSearch) bookSource.bookUrlPattern?.let {
            ...
            if (baseUrl.matches(it.toRegex())) {
                Debug.log(bookSource.bookSourceUrl, appCtx.getString(R.string.log_url_is_toc))
                getInfoItem(
                    bookSource,
                    analyzeRule,
                    analyzeUrl,
        ...
        Debug.log(bookSource.bookSourceUrl, appCtx.getString(R.string.log_get_book_list))
        collections = analyzeRule.getElements(ruleList)
        coroutineContext.ensureActive()
        if (collections.isEmpty() && bookSource.bookUrlPattern.isNullOrEmpty()) {
            Debug.log(bookSource.bookSourceUrl, appCtx.getString(R.string.log_list_empty_parse_detail))
            getInfoItem(
            ...
            Debug.log(bookSource.bookSourceUrl, "${appCtx.getString(R.string.log_list_size)}${collections.size}")
        ...
        Debug.log(bookSource.bookSourceUrl, "${appCtx.getString(R.string.log_book_total)}${bookList.size}")
        return bookList
    }
    ...
    private suspend fun getSearchItem(
        ...
        coroutineContext.ensureActive()
        Debug.log(bookSource.bookSourceUrl, appCtx.getString(R.string.log_get_book_name), log)
        ...
        if (searchBook.name.isNotEmpty()) {
            coroutineContext.ensureActive()
            Debug.log(bookSource.bookSourceUrl, appCtx.getString(R.string.log_get_author), log)
            ...
            coroutineContext.ensureActive()
            Debug.log(bookSource.bookSourceUrl, appCtx.getString(R.string.log_get_kind), log)
            try {
            ...
            coroutineContext.ensureActive()
            Debug.log(bookSource.bookSourceUrl, appCtx.getString(R.string.log_get_word_count), log)
            try {
            ...
            coroutineContext.ensureActive()
            Debug.log(bookSource.bookSourceUrl, appCtx.getString(R.string.log_get_last_chapter), log)
            try {
            ...
            coroutineContext.ensureActive()
            Debug.log(bookSource.bookSourceUrl, appCtx.getString(R.string.log_get_intro), log)
            try {
            ...
            coroutineContext.ensureActive()
            Debug.log(bookSource.bookSourceUrl, appCtx.getString(R.string.log_get_cover_url), log)
            try {
            ...
            coroutineContext.ensureActive()
            Debug.log(bookSource.bookSourceUrl, appCtx.getString(R.string.log_get_intro_url), log)
    ...
    private fun checkExploreJson(bookSource: BookSource) {
        ...
        GSON.fromJsonArray<ExploreKind>(json).getOrNull()?.let {
            Debug.log(appCtx.getString(R.string.err_explore_json_invalid))
        }
    }
